...
description: Gerenciar o ciclo de vida de processos administrativos de defesa de multas.
version: 1.0.0
...
## Purpose
Gerenciar o ciclo de vida de processos administrativos de defesa de multas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Case Management** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Case Management**.
