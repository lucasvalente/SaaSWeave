...
description: Normalizar datas, placas, códigos de infração e valores para o padrão canônico.
version: 1.0.0
...
## Purpose
Normalizar datas, placas, códigos de infração e valores para o padrão canônico.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Data Normalization** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Data Normalization**.
