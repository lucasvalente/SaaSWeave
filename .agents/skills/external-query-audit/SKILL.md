---
name: external-query-audit
description: Auditar requisições e respostas recebidas de sistemas públicos externos.
version: 1.0.0
...
# External Query Audit Skill

## Purpose
Auditar requisições e respostas recebidas de sistemas públicos externos.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **External Query Audit** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **External Query Audit**.
