...
description: Garantir disparo confiável de eventos e mensagens integrado a transações de banco.
version: 1.0.0
...
## Purpose
Garantir disparo confiável de eventos e mensagens integrado a transações de banco.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Transactional Outbox** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Transactional Outbox**.
