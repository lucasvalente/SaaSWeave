---
name: renainf-normalization
description: Normalizar extratos de infrações de trânsito obtidos via base RENAINF.
version: 1.0.0
...
# RENAINF Normalization Skill

## Purpose
Normalizar extratos de infrações de trânsito obtidos via base RENAINF.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **RENAINF Normalization** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **RENAINF Normalization**.
