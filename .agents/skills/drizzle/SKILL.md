---
name: drizzle
description: Construir esquemas relacionais, consultas SQL type-safe e relações com Drizzle ORM.
version: 1.0.0
...
## Purpose
Construir esquemas relacionais, consultas SQL type-safe e relações com Drizzle ORM.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Drizzle ORM** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Drizzle ORM**.
