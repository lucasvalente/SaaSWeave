---
name: senatran-integration
description: Conectar à base do SENATRAN para validação de dados de veículos e condutores.
version: 1.0.0
...
# SENATRAN Integration Skill

## Purpose
Conectar à base do SENATRAN para validação de dados de veículos e condutores.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **SENATRAN Integration** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **SENATRAN Integration**.
