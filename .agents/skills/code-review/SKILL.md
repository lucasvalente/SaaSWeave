---
name: code-review
description: Auditar qualidade, complexidade ciclomática e aderência a padrões em pull requests.
version: 1.0.0
...
## Purpose
Auditar qualidade, complexidade ciclomática e aderência a padrões em pull requests.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Code Review** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Code Review**.
