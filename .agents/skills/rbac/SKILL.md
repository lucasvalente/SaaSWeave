---
name: rbac
description: Definir e aplicar matriz de papéis e permissões granulares por unidade/tenant.
version: 1.0.0
...
## Purpose
Definir e aplicar matriz de papéis e permissões granulares por unidade/tenant.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Role-Based Access Control** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Role-Based Access Control**.
