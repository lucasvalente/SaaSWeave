---
name: driver-model
description: Modelar condutores, histórico de pontuação, CNH, categoria e vínculos com frotas.
version: 1.0.0
...
## Purpose
Modelar condutores, histórico de pontuação, CNH, categoria e vínculos com frotas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Driver Model** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Driver Model**.
