---
name: ocr-extraction
description: Extrair texto e dados estruturados de imagens e PDFs escaneados de notificações.
version: 1.0.0
...
## Purpose
Extrair texto e dados estruturados de imagens e PDFs escaneados de notificações.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **OCR Extraction** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **OCR Extraction**.
