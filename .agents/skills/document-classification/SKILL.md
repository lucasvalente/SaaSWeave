...
description: Classificar automaticamente autos de infração, notificações e documentos pessoais.
version: 1.0.0
...
## Purpose
Classificar automaticamente autos de infração, notificações e documentos pessoais.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Document Classification** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Document Classification**.
