---
name: protocol-evidence
description: Anexar e certificar recibos oficiais de entrega do protocolo de recurso.
version: 1.0.0
...
# Protocol Evidence Skill

## Purpose
Anexar e certificar recibos oficiais de entrega do protocolo de recurso.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Protocol Evidence** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Protocol Evidence**.
