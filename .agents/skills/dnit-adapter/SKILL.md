---
name: dnit-adapter
description: Integrar consultas de infrações e envio de defesas ao sistema eletrônico do DNIT.
version: 1.0.0
...
## Purpose
Integrar consultas de infrações e envio de defesas ao sistema eletrônico do DNIT.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **DNIT Adapter** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **DNIT Adapter**.
