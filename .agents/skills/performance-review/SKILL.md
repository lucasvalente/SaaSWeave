...
description: Auditar queries lentas, tamanho de pacotes JavaScript e uso de memória.
version: 1.0.0
...
## Purpose
Auditar queries lentas, tamanho de pacotes JavaScript e uso de memória.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Performance Review** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Performance Review**.
