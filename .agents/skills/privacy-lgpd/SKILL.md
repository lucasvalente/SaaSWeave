---
name: privacy-lgpd
description: Impor conformidade com a LGPD, mascaramento de dados e gestão de consentimento.
version: 1.0.0
...
## Purpose
Impor conformidade com a LGPD, mascaramento de dados e gestão de consentimento.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Privacy LGPD** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Privacy LGPD**.
