---
name: fact-model
description: Modelar fatos extraídos de um auto de infração para submissão ao motor de regras.
version: 1.0.0
...
## Purpose
Modelar fatos extraídos de um auto de infração para submissão ao motor de regras.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Fact Model** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Fact Model**.
