...
description: Executar testes negativos que comprovam a impossibilidade de vazamento entre tenants.
version: 1.0.0
...
# Tenant Isolation Testing Skill

## Purpose
Executar testes negativos que comprovam a impossibilidade de vazamento entre tenants.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Tenant Isolation Testing** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Tenant Isolation Testing**.
