---
name: opaque-sessions
description: Implementar gerenciamento de sessões opacas no servidor com armazenamento em Redis.
version: 1.0.0
...
# Opaque Sessions Skill

## Purpose
Implementar gerenciamento de sessões opacas no servidor com armazenamento em Redis.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Opaque Sessions** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Opaque Sessions**.
