...
description: Gerar resumos executivos de autos de infração e petições complexas.
version: 1.0.0
...
# AI Document Summary Skill

## Purpose
Gerar resumos executivos de autos de infração e petições complexas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **AI Document Summary** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **AI Document Summary**.
