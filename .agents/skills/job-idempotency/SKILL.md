...
description: Garantir que execuções repetidas de tarefas assíncronas não gerem duplicidades.
version: 1.0.0
...
# Job Idempotency Skill

## Purpose
Garantir que execuções repetidas de tarefas assíncronas não gerem duplicidades.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Job Idempotency** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Job Idempotency**.
