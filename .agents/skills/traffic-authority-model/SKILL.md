---
name: traffic-authority-model
description: Modelar órgãos autuadores, competências, endereços de protocolo e regras de envio.
version: 1.0.0
...
# Traffic Authority Model Skill

## Purpose
Modelar órgãos autuadores, competências, endereços de protocolo e regras de envio.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Traffic Authority Model** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Traffic Authority Model**.
