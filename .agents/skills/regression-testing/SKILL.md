...
description: Garantir que correções de bugs permaneçam estáveis ao longo de novos deploys.
version: 1.0.0
...
## Purpose
Garantir que correções de bugs permaneçam estáveis ao longo de novos deploys.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Regression Testing** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Regression Testing**.
