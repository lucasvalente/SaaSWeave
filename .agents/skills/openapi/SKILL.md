---
name: openapi
description: Especificar, manter e servir documentação de API em conformidade com OpenAPI 3.1.
version: 1.0.0
...
## Purpose
Especificar, manter e servir documentação de API em conformidade com OpenAPI 3.1.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **OpenAPI** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **OpenAPI**.
