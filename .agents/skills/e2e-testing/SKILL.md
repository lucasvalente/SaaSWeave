---
name: e2e-testing
description: Automatizar testes de ponta a ponta simulando jornadas de usuário no frontend.
version: 1.0.0
...
## Purpose
Automatizar testes de ponta a ponta simulando jornadas de usuário no frontend.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **E2E Testing** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **E2E Testing**.
