---
name: municipal-authority-adapter
description: Adaptar comunicação com secretarias municipais de trânsito e mobilidade.
version: 1.0.0
...
# Municipal Authority Adapter Skill

## Purpose
Adaptar comunicação com secretarias municipais de trânsito e mobilidade.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Municipal Authority Adapter** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Municipal Authority Adapter**.
