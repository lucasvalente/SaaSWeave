...
description: Permitir validação formal e assinatura de petição por advogado habilitado.
version: 1.0.0
...
# Human Legal Review Skill

## Purpose
Permitir validação formal e assinatura de petição por advogado habilitado.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Human Legal Review** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Human Legal Review**.
