---
name: defense-versioning
description: Versionar minutas de defesa mantendo histórico de alterações e revisões.
version: 1.0.0
...
# Defense Versioning Skill

## Purpose
Versionar minutas de defesa mantendo histórico de alterações e revisões.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Defense Versioning** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Defense Versioning**.
