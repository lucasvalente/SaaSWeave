...
description: Garantir acesso seguro a arquivos e documentos via URLs assinadas e tokens efêmeros.
version: 1.0.0
...
# Secure File Access Skill

## Purpose
Garantir acesso seguro a arquivos e documentos via URLs assinadas e tokens efêmeros.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Secure File Access** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Secure File Access**.
