...
description: Gerenciar migrações com estratégia segura Expand-Migrate-Contract.
version: 1.0.0
...
## Purpose
Gerenciar migrações com estratégia segura Expand-Migrate-Contract.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Database Migrations** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Database Migrations**.
