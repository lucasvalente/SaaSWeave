---
name: ai-defense-drafting
description: Gerar rascunhos de minutas com base em teses previamente aprovadas pelo motor de regras.
version: 1.0.0
...
# AI Defense Drafting Skill

## Purpose
Gerar rascunhos de minutas com base em teses previamente aprovadas pelo motor de regras.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **AI Defense Drafting** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **AI Defense Drafting**.
