---
name: integration-provider-pattern
description: Implementar adapters e provedores padronizados para fontes externas.
version: 1.0.0
...
# Integration Provider Pattern Skill

## Purpose
Implementar adapters e provedores padronizados para fontes externas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Integration Provider Pattern** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Integration Provider Pattern**.
