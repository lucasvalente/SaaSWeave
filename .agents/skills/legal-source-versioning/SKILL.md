---
name: legal-source-versioning
description: Gerenciar versões e períodos de vigência de leis, decretos, resoluções e portarias.
version: 1.0.0
...
metadata:
  hermes:
    ...
    tags: [autuax, legal-defense]
---

# Legal Source Versioning Skill

## Purpose
Gerenciar versões e períodos de vigência de leis, decretos, resoluções e portarias.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Legal Source Versioning** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Legal Source Versioning**.
