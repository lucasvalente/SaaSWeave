---
name: prometheus
description: Coletar e expor métricas de performance, saúde e contadores de operações HTTP/Worker.
version: 1.0.0
...
## Purpose
Coletar e expor métricas de performance, saúde e contadores de operações HTTP/Worker.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Prometheus** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Prometheus**.
