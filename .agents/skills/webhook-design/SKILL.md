---
name: webhook-design
description: Receber e despachar webhooks com validação de assinatura HMAC e retentativas.
version: 1.0.0
...
## Purpose
Receber e despachar webhooks com validação de assinatura HMAC e retentativas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Webhook Design** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Webhook Design**.
