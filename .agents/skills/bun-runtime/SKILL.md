---
name: bun-runtime
description: Operar no ambiente de execução Bun aproveitando sua velocidade e utilitários nativos.
version: 1.0.0
...
## Purpose
Operar no ambiente de execução Bun aproveitando sua velocidade e utilitários nativos.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Bun Runtime** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Bun Runtime**.
