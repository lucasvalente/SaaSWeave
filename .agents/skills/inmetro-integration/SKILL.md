---
name: inmetro-integration
description: Integrar com a base do INMETRO/PSIE para conferência de laudos metrológicos.
version: 1.0.0
...
# INMETRO Integration Skill

## Purpose
Integrar com a base do INMETRO/PSIE para conferência de laudos metrológicos.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **INMETRO Integration** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **INMETRO Integration**.
