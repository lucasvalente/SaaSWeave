...
description: Criar templates parametrizados de petições para cada fase recursal.
version: 1.0.0
...
# Defense Template Skill

## Purpose
Criar templates parametrizados de petições para cada fase recursal.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Defense Template** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Defense Template**.
