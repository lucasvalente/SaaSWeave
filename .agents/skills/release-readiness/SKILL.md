...
description: Avaliar checklist abrangente antes de liberar uma nova versão para homologação ou produção.
version: 1.0.0
...
## Purpose
Avaliar checklist abrangente antes de liberar uma nova versão para homologação ou produção.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Release Readiness** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Release Readiness**.
