---
name: csrf
description: Prevenir ataques de Cross-Site Request Forgery com tokens e validação SameSite.
version: 1.0.0
...
## Purpose
Prevenir ataques de Cross-Site Request Forgery com tokens e validação SameSite.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **CSRF Protection** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **CSRF Protection**.
