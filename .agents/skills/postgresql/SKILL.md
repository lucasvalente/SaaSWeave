---
name: postgresql
description: Configurar e utilizar PostgreSQL 16 com melhores práticas de configuração e integridade.
version: 1.0.0
...
## Purpose
Configurar e utilizar PostgreSQL 16 com melhores práticas de configuração e integridade.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **PostgreSQL** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **PostgreSQL**.
