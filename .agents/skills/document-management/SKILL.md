...
description: Gerenciar upload, classificação e indexação de anexos probatórios e petições.
version: 1.0.0
...
## Purpose
Gerenciar upload, classificação e indexação de anexos probatórios e petições.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Document Management** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Document Management**.
