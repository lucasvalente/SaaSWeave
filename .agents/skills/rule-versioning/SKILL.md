...
description: Versionar regras de consistência associando-as à vigência legal correspondente.
version: 1.0.0
...
# Rule Versioning Skill

## Purpose
Versionar regras de consistência associando-as à vigência legal correspondente.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Rule Versioning** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Rule Versioning**.
