---
name: vehicle-model
description: Modelar veículos, dados do RENAVAM, chassi, placa, categoria e proprietário formal.
version: 1.0.0
...
## Purpose
Modelar veículos, dados do RENAVAM, chassi, placa, categoria e proprietário formal.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Vehicle Model** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Vehicle Model**.
