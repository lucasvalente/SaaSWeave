---
name: api-testing
description: Validar contratos, status HTTP e payloads das rotas de API do backend Hono.
version: 1.0.0
...
## Purpose
Validar contratos, status HTTP e payloads das rotas de API do backend Hono.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **API Testing** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **API Testing**.
