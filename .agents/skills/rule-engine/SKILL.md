---
name: rule-engine
description: Executar motor de regras determinístico sobre os fatos da autuação.
version: 1.0.0
...
## Purpose
Executar motor de regras determinístico sobre os fatos da autuação.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Rule Engine** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Rule Engine**.
