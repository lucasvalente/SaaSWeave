---
name: postgres-rls
description: Configurar e auditar políticas de Row Level Security para segregação de dados.
version: 1.0.0
...
metadata:
  hermes:
    category: database
    tags: [autuax, database]
---

# PostgreSQL RLS Skill

## Purpose
Configurar e auditar políticas de Row Level Security para segregação de dados.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **PostgreSQL RLS** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **PostgreSQL RLS**.
