...
description: Registrar comprovantes, datas e números de protocolo de recursos perante órgãos.
version: 1.0.0
...
## Purpose
Registrar comprovantes, datas e números de protocolo de recursos perante órgãos.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Protocol Management** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Protocol Management**.
