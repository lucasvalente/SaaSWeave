---
name: signed-urls
description: Gerar URLs pré-assinadas temporárias para upload e download direto de arquivos.
version: 1.0.0
...
## Purpose
Gerar URLs pré-assinadas temporárias para upload e download direto de arquivos.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Signed URLs** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Signed URLs**.
