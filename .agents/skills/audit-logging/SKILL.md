---
name: audit-logging
description: Registrar trilhas imutáveis de auditoria para ações privilegiadas e acessos a dados.
version: 1.0.0
...
## Purpose
Registrar trilhas imutáveis de auditoria para ações privilegiadas e acessos a dados.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Audit Logging** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Audit Logging**.
