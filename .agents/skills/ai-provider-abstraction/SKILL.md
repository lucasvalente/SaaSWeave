...
description: Desacoplar provedores de IA (OpenAI, Anthropic, Gemini) via interfaces neutras.
version: 1.0.0
...
## Purpose
Desacoplar provedores de IA (OpenAI, Anthropic, Gemini) via interfaces neutras.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **AI Provider Abstraction** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **AI Provider Abstraction**.
