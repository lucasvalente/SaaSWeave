...
description: Implementar rotas tipadas, loaders, error boundaries e layouts no frontend.
version: 1.0.0
...
## Purpose
Implementar rotas tipadas, loaders, error boundaries e layouts no frontend.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **TanStack Router** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **TanStack Router**.
