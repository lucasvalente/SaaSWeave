---
name: state-authority-adapter
description: Adaptar comunicação com DETRANs estaduais e DERs.
version: 1.0.0
...
# State Authority Adapter Skill

## Purpose
Adaptar comunicação com DETRANs estaduais e DERs.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **State Authority Adapter** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **State Authority Adapter**.
