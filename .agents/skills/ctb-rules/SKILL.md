---
name: ctb-rules
description: Modelar artigos e tipificações do Código de Trânsito Brasileiro (Lei 9.503/1997).
version: 1.0.0
...
## Purpose
Modelar artigos e tipificações do Código de Trânsito Brasileiro (Lei 9.503/1997).

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **CTB Rules** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **CTB Rules**.
