...
description: Analisar planos de execução (EXPLAIN ANALYZE) e mitigar consultas lentas ou N+1.
version: 1.0.0
...
## Purpose
Analisar planos de execução (EXPLAIN ANALYZE) e mitigar consultas lentas ou N+1.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Query Performance** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Query Performance**.
