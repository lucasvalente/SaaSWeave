...
description: Assegurar isolamento absoluto de dados entre tenants em todas as camadas.
version: 1.0.0
...
## Purpose
Assegurar isolamento absoluto de dados entre tenants em todas as camadas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Multi-Tenant Isolation** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Multi-Tenant Isolation**.
