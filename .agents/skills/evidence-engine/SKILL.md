...
description: Consolidar evidências factuais e documentais que sustentam cada apontamento de vício.
version: 1.0.0
...
metadata:
  hermes:
    ...
    tags: [autuax, autuax-intelligence]
---

# Evidence Engine Skill

## Purpose
Consolidar evidências factuais e documentais que sustentam cada apontamento de vício.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Evidence Engine** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Evidence Engine**.
