---
name: ai-finding-explanation
description: Explicar didaticamente vícios identificados para operadores e clientes leigos.
version: 1.0.0
...
# AI Finding Explanation Skill

## Purpose
Explicar didaticamente vícios identificados para operadores e clientes leigos.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **AI Finding Explanation** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **AI Finding Explanation**.
