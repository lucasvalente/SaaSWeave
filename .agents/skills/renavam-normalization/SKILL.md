---
name: renavam-normalization
description: Normalizar dados cadastrais de veículos obtidos do sistema RENAVAM.
version: 1.0.0
...
# RENAVAM Normalization Skill

## Purpose
Normalizar dados cadastrais de veículos obtidos do sistema RENAVAM.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **RENAVAM Normalization** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **RENAVAM Normalization**.
