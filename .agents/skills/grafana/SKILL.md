---
name: grafana
description: Visualizar métricas operacionais e dashboards de desempenho da plataforma.
version: 1.0.0
...
## Purpose
Visualizar métricas operacionais e dashboards de desempenho da plataforma.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Grafana** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Grafana**.
