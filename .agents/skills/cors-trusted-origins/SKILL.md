---
name: cors-trusted-origins
description: Restringir origens confiáveis e cabeçalhos autorizados no servidor HTTP.
version: 1.0.0
...
# CORS & Trusted Origins Skill

## Purpose
Restringir origens confiáveis e cabeçalhos autorizados no servidor HTTP.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **CORS & Trusted Origins** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **CORS & Trusted Origins**.
