---
name: data-integrity
description: Garantir consistência relacional por meio de constraints, enums e validações estritas.
version: 1.0.0
...
## Purpose
Garantir consistência relacional por meio de constraints, enums e validações estritas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Data Integrity** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Data Integrity**.
