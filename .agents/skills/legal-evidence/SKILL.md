---
name: legal-evidence
description: Estruturar anexos probatórios conforme exigências de admissibilidade processual.
version: 1.0.0
...
# Legal Evidence Skill

## Purpose
Estruturar anexos probatórios conforme exigências de admissibilidade processual.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Legal Evidence** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Legal Evidence**.
