---
name: analysis-runs
description: Orquestrar execuções de análise com rastreabilidade completa de entradas e saídas.
version: 1.0.0
...
## Purpose
Orquestrar execuções de análise com rastreabilidade completa de entradas e saídas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Analysis Runs** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Analysis Runs**.
