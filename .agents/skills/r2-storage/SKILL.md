---
name: r2-storage
description: Armazenar objetos e anexos em provedor S3 compatível ou Cloudflare R2.
version: 1.0.0
...
## Purpose
Armazenar objetos e anexos em provedor S3 compatível ou Cloudflare R2.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **R2 / S3 Storage** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **R2 / S3 Storage**.
