...
description: Conduzir auditoria de segurança estática e dinâmica antes da liberação de código.
version: 1.0.0
...
## Purpose
Conduzir auditoria de segurança estática e dinâmica antes da liberação de código.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Security Review** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Security Review**.
