---
name: crm-pipeline
description: Acompanhar etapas de prospecção, atendimento e pós-venda para clientes da plataforma.
version: 1.0.0
...
## Purpose
Acompanhar etapas de prospecção, atendimento e pós-venda para clientes da plataforma.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **CRM Pipeline** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **CRM Pipeline**.
