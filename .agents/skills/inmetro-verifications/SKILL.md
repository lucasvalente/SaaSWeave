---
name: inmetro-verifications
description: Validar data de verificação metrológica periódica (validade máxima de 12 meses).
version: 1.0.0
...
# INMETRO Verifications Skill

## Purpose
Validar data de verificação metrológica periódica (validade máxima de 12 meses).

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **INMETRO Verifications** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **INMETRO Verifications**.
