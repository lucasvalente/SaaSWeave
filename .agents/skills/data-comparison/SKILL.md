...
description: Cruzar dados do AIT contra bases oficiais para detectar divergências de cadastro.
version: 1.0.0
...
# Data Comparison Skill

## Purpose
Cruzar dados do AIT contra bases oficiais para detectar divergências de cadastro.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Data Comparison** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Data Comparison**.
