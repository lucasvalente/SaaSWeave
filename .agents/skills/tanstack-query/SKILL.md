---
name: tanstack-query
description: Gerenciar estado de servidor remoto, cache, invalidação e sincronização assíncrona.
version: 1.0.0
...
## Purpose
Gerenciar estado de servidor remoto, cache, invalidação e sincronização assíncrona.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **TanStack Query** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **TanStack Query**.
