...
description: Testar fluxos completos integrando banco de dados PostgreSQL e cache Redis.
version: 1.0.0
...
## Purpose
Testar fluxos completos integrando banco de dados PostgreSQL e cache Redis.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Integration Testing** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Integration Testing**.
