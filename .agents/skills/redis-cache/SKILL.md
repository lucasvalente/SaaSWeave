---
name: redis-cache
description: Gerenciar caching inteligente com TTL, namespaces e invalidação precisa.
version: 1.0.0
...
## Purpose
Gerenciar caching inteligente com TTL, namespaces e invalidação precisa.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Redis Cache** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Redis Cache**.
