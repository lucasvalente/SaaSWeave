---
name: healthchecks
description: Expor endpoints de liveness e readiness com verificação real de dependências críticas.
version: 1.0.0
...
## Purpose
Expor endpoints de liveness e readiness com verificação real de dependências críticas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Healthchecks** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Healthchecks**.
