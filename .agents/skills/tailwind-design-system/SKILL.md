...
description: Aplicar design tokens centralizados de cores, tipografia, espaçamento e temas.
version: 1.0.0
...
## Purpose
Aplicar design tokens centralizados de cores, tipografia, espaçamento e temas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Tailwind Design System** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Tailwind Design System**.
