---
name: case-instances
description: Modelar instâncias recursais (Defesa Prévia, JARI 1ª instância, CETRAN 2ª instância).
version: 1.0.0
...
## Purpose
Modelar instâncias recursais (Defesa Prévia, JARI 1ª instância, CETRAN 2ª instância).

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Case Instances** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Case Instances**.
