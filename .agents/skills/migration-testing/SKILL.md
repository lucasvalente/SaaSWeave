...
description: Verificar integridade da execução e rollback de scripts de migração Drizzle.
version: 1.0.0
...
## Purpose
Verificar integridade da execução e rollback de scripts de migração Drizzle.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Migration Testing** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Migration Testing**.
