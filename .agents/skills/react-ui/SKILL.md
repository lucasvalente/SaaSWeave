---
name: react-ui
description: Construir componentes React modernos, performáticos e com renderização eficiente.
version: 1.0.0
...
## Purpose
Construir componentes React modernos, performáticos e com renderização eficiente.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **React UI** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **React UI**.
