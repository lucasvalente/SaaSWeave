---
name: hono-api
description: Desenvolver endpoints HTTP rápidos, tipados e com middleware limpo no backend Hono.
version: 1.0.0
...
## Purpose
Desenvolver endpoints HTTP rápidos, tipados e com middleware limpo no backend Hono.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Hono API** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Hono API**.
