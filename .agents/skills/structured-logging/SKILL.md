...
description: Emitir logs padronizados em JSON enriquecidos com metadados e contexto de execução.
version: 1.0.0
...
## Purpose
Emitir logs padronizados em JSON enriquecidos com metadados e contexto de execução.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Structured Logging** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Structured Logging**.
