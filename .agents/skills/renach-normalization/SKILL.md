---
name: renach-normalization
description: Normalizar pontuações e prontuários de CNH da base RENACH.
version: 1.0.0
...
# RENACH Normalization Skill

## Purpose
Normalizar pontuações e prontuários de CNH da base RENACH.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **RENACH Normalization** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **RENACH Normalization**.
