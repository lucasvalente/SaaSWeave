...
description: Gerenciar credenciais, chaves criptográficas e variáveis sem exposição no código.
version: 1.0.0
...
## Purpose
Gerenciar credenciais, chaves criptográficas e variáveis sem exposição no código.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Secret Management** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Secret Management**.
