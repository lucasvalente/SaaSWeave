...
description: Criar e manter índices simples, compostos e parciais para otimização de consultas.
version: 1.0.0
...
## Purpose
Criar e manter índices simples, compostos e parciais para otimização de consultas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Database Indexing** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Database Indexing**.
