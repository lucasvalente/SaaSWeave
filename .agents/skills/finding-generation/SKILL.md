...
description: Gerar apontamentos e teses de irregularidade com base nos resultados das regras.
version: 1.0.0
...
## Purpose
Gerar apontamentos e teses de irregularidade com base nos resultados das regras.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Finding Generation** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Finding Generation**.
