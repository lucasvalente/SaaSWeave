...
description: Calcular repasses e comissionamento para escritórios despachantes parceiros.
version: 1.0.0
...
# Partner Commissions Skill

## Purpose
Calcular repasses e comissionamento para escritórios despachantes parceiros.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Partner Commissions** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Partner Commissions**.
