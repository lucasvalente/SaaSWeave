...
description: Propagar requestId e correlationId através de todas as camadas e processos assíncronos.
version: 1.0.0
...
metadata:
  hermes:
    ...
    tags: [autuax, observability]
---

# Request Correlation Skill

## Purpose
Propagar requestId e correlationId através de todas as camadas e processos assíncronos.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Request Correlation** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Request Correlation**.
