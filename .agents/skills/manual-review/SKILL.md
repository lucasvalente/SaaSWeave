---
name: manual-review
description: Encaminhar casos com inconsistências ambíguas para revisão por advogado responsável.
version: 1.0.0
...
## Purpose
Encaminhar casos com inconsistências ambíguas para revisão por advogado responsável.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Manual Review** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Manual Review**.
