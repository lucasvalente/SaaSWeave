---
name: tanstack-store
description: Utilizar reatividade leve para estados locais de alta performance.
version: 1.0.0
...
## Purpose
Utilizar reatividade leve para estados locais de alta performance.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **TanStack Store** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **TanStack Store**.
