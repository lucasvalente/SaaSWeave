...
description: Executar mutações atômicas com controle de isolamento e consistência ACID.
version: 1.0.0
...
## Purpose
Executar mutações atômicas com controle de isolamento e consistência ACID.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Database Transactions** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Database Transactions**.
