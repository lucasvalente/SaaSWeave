---
name: opentelemetry
description: Instrumentar tracing distribuído para mensuração de latência e dependências externas.
version: 1.0.0
...
## Purpose
Instrumentar tracing distribuído para mensuração de latência e dependências externas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **OpenTelemetry** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **OpenTelemetry**.
