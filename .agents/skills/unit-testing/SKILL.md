---
name: unit-testing
description: Escrever testes unitários rápidos e determinísticos com Vitest cobrindo regras de negócio.
version: 1.0.0
...
## Purpose
Escrever testes unitários rápidos e determinísticos com Vitest cobrindo regras de negócio.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Unit Testing** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Unit Testing**.
