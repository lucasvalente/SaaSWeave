---
name: schema-design
description: Modelar tabelas, normalização, chaves estrangeiras e integridade referencial.
version: 1.0.0
...
## Purpose
Modelar tabelas, normalização, chaves estrangeiras e integridade referencial.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Schema Design** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Schema Design**.
