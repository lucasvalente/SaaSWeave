...
description: Configurar e impor tipagem estrita de ponta a ponta sem any ou casts inseguros.
version: 1.0.0
...
## Purpose
Configurar e impor tipagem estrita de ponta a ponta sem any ou casts inseguros.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **TypeScript Strict** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **TypeScript Strict**.
