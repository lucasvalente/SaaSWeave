...
description: Consumir endpoints backend a partir do frontend com inferência estrita de tipos.
version: 1.0.0
...
# Typed API Client Skill

## Purpose
Consumir endpoints backend a partir do frontend com inferência estrita de tipos.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Typed API Client** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Typed API Client**.
