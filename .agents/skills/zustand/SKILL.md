---
name: zustand
description: Gerenciar estados de interface complexos e fluxos locais compartilhados no cliente.
version: 1.0.0
...
## Purpose
Gerenciar estados de interface complexos e fluxos locais compartilhados no cliente.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Zustand** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Zustand**.
