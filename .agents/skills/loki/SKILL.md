---
name: loki
description: Agregar logs estruturados com retenção eficiente e busca correlacionada.
version: 1.0.0
...
## Purpose
Agregar logs estruturados com retenção eficiente e busca correlacionada.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Loki** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Loki**.
