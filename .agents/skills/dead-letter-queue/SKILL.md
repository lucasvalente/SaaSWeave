...
description: Reter e analisar mensagens com falhas consecutivas em filas segregadas.
version: 1.0.0
...
## Purpose
Reter e analisar mensagens com falhas consecutivas em filas segregadas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Dead Letter Queue** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Dead Letter Queue**.
