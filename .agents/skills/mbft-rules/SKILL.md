---
name: mbft-rules
description: Codificar fichas de fiscalização do Manual Brasileiro de Fiscalização de Trânsito.
version: 1.0.0
...
## Purpose
Codificar fichas de fiscalização do Manual Brasileiro de Fiscalização de Trânsito.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **MBFT Rules** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **MBFT Rules**.
