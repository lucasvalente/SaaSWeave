---
name: authentication
description: Gerenciar autenticação segura de usuários com suporte a múltiplos fatores.
version: 1.0.0
...
## Purpose
Gerenciar autenticação segura de usuários com suporte a múltiplos fatores.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Authentication** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Authentication**.
