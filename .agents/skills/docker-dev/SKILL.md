---
name: docker-dev
description: Manter ambiente de desenvolvimento local orquestrado via Docker Compose.
version: 1.0.0
...
## Purpose
Manter ambiente de desenvolvimento local orquestrado via Docker Compose.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Docker Dev** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Docker Dev**.
