...
description: Investigar e depurar anomalias em produção utilizando métricas e rastreamento de logs.
version: 1.0.0
...
## Purpose
Investigar e depurar anomalias em produção utilizando métricas e rastreamento de logs.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Incident Debugging** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Incident Debugging**.
