---
name: contran-rules
description: Mapear resoluções do CONTRAN que regulamentam a fiscalização e sinalização.
version: 1.0.0
...
## Purpose
Mapear resoluções do CONTRAN que regulamentam a fiscalização e sinalização.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **CONTRAN Rules** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **CONTRAN Rules**.
