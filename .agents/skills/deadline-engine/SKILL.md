...
description: Calcular prazos decadenciais e prescricionais considerando feriados e dias úteis.
version: 1.0.0
...
# Deadline Engine Skill

## Purpose
Calcular prazos decadenciais e prescricionais considerando feriados e dias úteis.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Deadline Engine** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Deadline Engine**.
