...
description: Exigir aprovação humana antes de qualquer despacho externo gerado com auxílio de IA.
version: 1.0.0
...
## Purpose
Exigir aprovação humana antes de qualquer despacho externo gerado com auxílio de IA.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Human-in-the-Loop** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Human-in-the-Loop**.
