---
name: case-state-machine
description: Controlar transições válidas de estados de um processo administrativo.
version: 1.0.0
...
# Case State Machine Skill

## Purpose
Controlar transições válidas de estados de um processo administrativo.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Case State Machine** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Case State Machine**.
