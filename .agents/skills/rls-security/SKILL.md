---
name: rls-security
description: Impor políticas de segurança a nível de linha no PostgreSQL para isolamento de dados.
version: 1.0.0
...
## Purpose
Impor políticas de segurança a nível de linha no PostgreSQL para isolamento de dados.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **RLS Security** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **RLS Security**.
