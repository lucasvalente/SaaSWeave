---
name: zod-validation
description: Validar rigorosamente schemas de dados de entrada e saída em tempo de execução.
version: 1.0.0
...
## Purpose
Validar rigorosamente schemas de dados de entrada e saída em tempo de execução.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Zod Validation** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Zod Validation**.
