---
name: retry-backoff
description: Implementar algoritmos de retentativa com recuo exponencial e jitter.
version: 1.0.0
...
## Purpose
Implementar algoritmos de retentativa com recuo exponencial e jitter.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Retry Backoff** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Retry Backoff**.
