---
name: queue-design
description: Arquitetar filas de processamento assíncrono BullMQ com priorização e particionamento.
version: 1.0.0
...
## Purpose
Arquitetar filas de processamento assíncrono BullMQ com priorização e particionamento.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Queue Design** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Queue Design**.
