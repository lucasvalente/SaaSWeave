---
name: authorization
description: Validar direitos de acesso e autorização em nível de serviço e rota.
version: 1.0.0
...
## Purpose
Validar direitos de acesso e autorização em nível de serviço e rota.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **Authorization** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **Authorization**.
