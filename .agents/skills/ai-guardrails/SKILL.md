---
name: ai-guardrails
description: Prevenir alucinações e vetar comandos que simulem decisões judiciais autônomas.
version: 1.0.0
...
## Purpose
Prevenir alucinações e vetar comandos que simulem decisões judiciais autônomas.

## When to use
Utilize esta skill sempre que trabalhar em tarefas, revisões ou alterações relacionadas a **AI Guardrails** no ecossistema AUTUAX.
...
2. Aplicar as convenções e padrões estritos definidos para **AI Guardrails**.
